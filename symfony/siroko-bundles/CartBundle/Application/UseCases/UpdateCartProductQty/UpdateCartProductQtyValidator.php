...
class UpdateCartProductQtyValidator
{
    ...
    public function validate(UpdateCartProductQtyCommand $command): void
    {
        ...
        if(!$cart)
        {
            $violations->add($this->validatorHelper->buildConstraintViolation('CartCode does not exist.', 'cartCode', $command->cartCode));
        }
        else
        {
            ...
            if(!$productExists)
            {
                ...
                if(!$product)
                {
                    $violations->add($this->validatorHelper->buildConstraintViolation('Product does not exist in database.', 'productId', $command->productId));
                }
